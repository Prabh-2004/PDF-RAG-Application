...
# Checking if user gave api key
if api_key:
    llm = ChatGroq(model="openai/gpt-oss-120b", groq_api_key=api_key)
    # Chat Interface
    session_id = st.text_input("Please enter your Session ID", value="default_session")

    if 'store' not in st.session_state:
        st.session_state.store = {}
    
    # Loadinf the User pdf file
